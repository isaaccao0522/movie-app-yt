...
//// Others
import { fetchTvSeries } from "../server/api";
...
const Shows: FC<IShowsProps> = (props) => {
    ...
    <Container maxW={"Container.xl"}>
      <Flex alignItems={"baseline"} gap={"4"} my="10">
        ...
        >
          ...
          <option value="title.asc&vote_count.gte=1000">Title</option>
        </Select>
      </Flex>
        ...
        {shows &&
          shows?.map((item, i) =>
            isLoading ? (
              ...
              <CardComponent item={item} type={"tv"} key={item?.id} />
            )
          )}
      </Grid>
